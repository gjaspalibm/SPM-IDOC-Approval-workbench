sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("mmal/spm/fi/ZSPM_IDOC_APPR_WB/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#AdjustmentWorkbench-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#AdjustmentWorkbench-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("mmal.spm.fi.ZSPM_IDOC_APPR_WB.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["mmal/spm/fi/ZSPM_IDOC_APPR_WB/localService/mockserver"], function (mockserver) {
