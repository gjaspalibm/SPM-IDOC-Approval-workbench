sap.ui.define([
	...
	return BaseObject.extend("mmal.spm.fi.ZSPM_IDOC_APPR_WB.model.GroupSortState", {
		 ...
		 * @alias mmal.spm.fi.ZSPM_IDOC_APPR_WB.model.GroupSortState
		 */
		...
		/**
		 * Sorts by idocNumber, or by amount
		 *
		...
		group: function (sKey) {
			...
			if (sKey === "amount") {
				...
				this._oViewModel.setProperty("/sortBy", "idocNumber");
			}
